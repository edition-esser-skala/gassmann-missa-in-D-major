...
CrucifixusViolinoI = {
  \relative c' {
    ...
    r16 g'\fE b g d' b g' d b'8 b
    b4 r r %180
    r16 d,, es d fis d a' fis a'8 a
    a4 r r
    r16 g, b g d' b g' d h'8 d
    d4 r r
    r16 c,, es c g' es c' g es'8 es %185
    es4 d16 g, h g g'8 h,
    c4 r c
    c h c
    ...
    r16 g, c g es' c g'8 r4
    r16 fis, a fis fis' d a'8 r4
    r16 b, d b g' d b'8 r4
    r16 b, e b g' e b'8 r4
    r16 g, a g d' a a'8 r4 %200
    r16 fis, a fis fis' d a'8 r4
    r16 g, b g d' b g' d b'8 g,,
...
BenedictusViolinoI = {
  \relative c' {
    ...
    d cis h8 r16 h d fis %5
    g8 g4 g8~
    g fis16 g a h g fis
    \appoggiatura fis8 e4 r8 a,16. a,32
    a2~
    a8 cis d a'16. a,32 %10
    \once \tieDashed a2~
    a8 cis d16 a' d16. a32
    h8 g'16 e d8 cis
    \appoggiatura cis d4 r8 fis16. h,32
    ais4 h8 fis'16. d32 %15
    cis4 d8 h'16. fis32
    ...
    a,8 a' r a
    g g, r16 g' \tuplet 3/2 8 { g[ fis g] }
    g,8 g' r g
    fis16. g32 g16.([ fis64 g)] a16 fis e d %35
    cis16. h32 a8 r a16. a,32
    a2~
    a8 cis d a'16. a,32
    \once \tieDashed a2~
    a8 cis d16 fis a d %40
    h8 g'16 e d8 cis
    d16.\f d,32 fis16. a32 d8 a'16. d,32
    cis4( d8) a'16. fis32
    e4( fis8) d'16. a32
    h4~ \tuplet 3/2 8 { h16 a g fis[ e d] } %45
    ...
    fis4 r8 d'
    d, a' a a
    g h r16 h \tuplet 3/2 8 { h[ a h] } %55
    h8 r r16 d cis h
    ais8 gis16 fis h8 fis
    g g g e
    d d cis cis
    h fis16. d32 h8 h'16. h,32 %60
    h2~
    h8 dis e h'16. h,32
    h2~
    h8 dis e g16 h
    ais8.( gis32 fis) h16 d fis h %65
    ...
    h h~ h16 h, cis e
    d8.( cis32 h) cis4\trill
    h8 fis h,4\fermata \bar "||" %73 finis
  }
}
...
OsannaViolinoI = {
  \relative c' {
    ...
    d2 fis4. e16 fis
    <g a,>2 <fis a,>
    fis4. gis8 gis4. fis16 gis
    a4 a, cis e
    a8 a, e' a, fis' d a fis' %115
    g e cis g e g cis e
